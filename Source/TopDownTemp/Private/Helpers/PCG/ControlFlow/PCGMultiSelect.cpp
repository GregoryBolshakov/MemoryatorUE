...
FPCGDataCollection MyOwnGatherDataForPin(const FPCGDataCollection& InputData, const FName InputLabel, const FName OutputLabel)
{
...
bool FPCGMultiSelectElement::ExecuteInternal(FPCGContext* Context) const
{
	...
	Context->OutputData = MyOwnGatherDataForPin(Context->InputData, SelectedPinLabel, PCGPinConstants::DefaultOutputLabel);
