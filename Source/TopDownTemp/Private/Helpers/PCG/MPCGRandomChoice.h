...
class UMPCGRandomChoiceSettings : public UPCGSettings
{
    GENERATED_BODY()
public:
    UMPCGRandomChoiceSettings();
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Settings", meta = (PCG_Overridable, ClampMin = 0, EditCondition = "bFixedMode", EditConditionHides))
